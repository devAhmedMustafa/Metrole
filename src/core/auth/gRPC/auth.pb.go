...
const file_auth_proto_rawDesc = "" +
	...
	"\x05token\x18\x02 \x01(\tR\x05token2H\n" +
	"\bAuthGrpc\x12<\n" +
	"\vGoogleLogin\x12\x18.auth.GoogleLoginRequest\x1a\x13.auth.LoginResponseB#Z!metrole/src/core/auth/gRPC;authpbb\x06proto3"
...
var file_auth_proto_depIdxs = []int32{
	0, // 0: auth.AuthGrpc.GoogleLogin:input_type -> auth.GoogleLoginRequest
	1, // 1: auth.AuthGrpc.GoogleLogin:output_type -> auth.LoginResponse
